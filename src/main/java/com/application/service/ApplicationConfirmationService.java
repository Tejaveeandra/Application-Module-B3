...
// private final StudentOrientationDetailsRepository
// studentOrientationDetailsRepository;
...
// private final CmpsOrientationStreamViewRepository
// cmpsOrientationStreamViewRepository;
// private final CmpsOrientationProgramViewRepository
// cmpsOrientationProgramViewRepository;
// private final CmpsOrientationBatchFeeViewRepository
...
// }
//
//// @Cacheable(value = "concessionReasons")
...
// }
//
//// @Cacheable(value = "programsByStream", key = "#streamId")
// public List<ProgramDTO> getProgramsByStreamId(int streamId) {
// List<CmpsOrientationStreamView> streamViews =
// cmpsOrientationStreamViewRepository.findByStreamId(streamId);
...
// .map(view -> new ProgramDTO(view.getProgramId(),
// view.getProgramName())).distinct()
// .collect(Collectors.toList());
// }
//
//// @Cacheable(value = "dropdownAcademicYears")
// public Map<String, Object> getDropdownAcademicYears() {
// int currentYear = Year.now().getValue();
// int nextYear = currentYear + 1;
// List<AcademicYear> years = academicYearRepo.findByYearIn(List.of(currentYear,
// nextYear));
// AcademicYear defaultYear = years.stream().filter(y -> y.getYear() ==
// nextYear).findFirst().orElse(null);
...
// List<CmpsOrientationStreamView> allData =
// cmpsOrientationStreamViewRepository.findByCmpsId(campusId);
// return allData.stream()
// .map(data -> new OrientationDTO(data.getOrientationId(),
// data.getOrientationName()))
...
// List<CmpsOrientationStreamView> allData =
// cmpsOrientationStreamViewRepository.findByOrientationId(orientationId);
// return allData.stream()
// .map(data -> new StreamDTO(data.getStreamId(),
// data.getStreamName())).distinct()
// .collect(Collectors.toList());
// }
//
...
// List<CmpsOrientationProgramView> result =
// cmpsOrientationProgramViewRepository.findByOrientationId(orientationId);
// return result.stream().map(data -> new ProgramDTO(data.getProgramId(),
// data.getProgramName()))
// .distinct().collect(Collectors.toList());
// }
//
//// @Cacheable(value = "examProgramsByProgram", key = "#programId")
// public List<ExamProgramDTO> getExamProgramsByProgramId(int programId) {
// List<CmpsOrientationProgramView> result =
// cmpsOrientationProgramViewRepository.findByProgramId(programId);
// return result.stream()
// .map(data -> new ExamProgramDTO(data.getExamProgramId(),
// data.getExamProgramName()))
// .distinct().collect(Collectors.toList());
// }
//
...
// return
// cmpsOrientationBatchFeeViewRepository.findByOrientationId(orientationId).stream()
// .map(data -> new BatchDTO(data.getOrientationBatchId(),
// data.getOrientationBatchName()))
// .distinct().collect(Collectors.toList());
// }
//
//// @Cacheable(value = "batchDetails", key = "{#orientationId,
// #orientationBatchId}")
// public List<BatchDetailsDTO> getBatchDetails(int orientationId, int
// orientationBatchId) {
...
// }
// return batchDetailsList.stream().filter(Objects::nonNull).map(data -> new
// BatchDetailsDTO(
// data.getOrientationStartDate(), data.getOrientationEndDate(),
// data.getOrientationFee()))
// .collect(Collectors.toList());
// }
//
//// @Cacheable(value = "sectionsByBatch", key = "#orientationBatchId")
// public List<SectionDTO> getSectionsByBatchId(int orientationBatchId) {
// return
// cmpsOrientationBatchFeeViewRepository.findByOrientationBatchId(orientationBatchId).stream()
// .filter(Objects::nonNull)
// .map(data -> new SectionDTO(data.getSectionId(),
// data.getSectionName())).distinct()
// .collect(Collectors.toList());
// }
//
//// @Cacheable(value = "campusAndZone", key = "#admissionNo")
...
// if (studentDetails.getCampus() != null &&
// studentDetails.getCampus().getZone() != null) {
...
// }
//
//// @Cacheable(value = "courseFee", key = "{#cmpsId, #orientationId,
// #orientationBatchId}")
// public Optional<Float> getCourseFeeByDetails(int cmpsId, int orientationId,
...
// }
//
//// @Cacheable(value = "studentDetails", key = "#admissionNo")
// public Optional<StudentDetailsDTO> getStudentDetailsByAdmissionNo(String
// admissionNo) {
// Optional<StudentAcademicDetails> academicDetailsOptional =
// academicRepo.findByStudAdmsNo(admissionNo);
...
// parentDetailsRepo.findByStudentAcademicDetails(academicDetails);
// int admissionNumber;
// List<StateApp> matchingStateApps = List.of();
// try {
// admissionNumber = Integer.parseInt(admissionNo);
// matchingStateApps =
// stateAppRepository.findAllByAdmissionNoBetweenRange(admissionNumber);
...
// dto.setGender(
// academicDetails.getGender() != null ?
// academicDetails.getGender().getGenderName() : "N/A");
// parentDetailsList.forEach(parent -> {
// if (parent.getStudentRelation() != null) {
// if
// ("Father".equalsIgnoreCase(parent.getStudentRelation().getStudent_relation_type()))
// {
// dto.setFathername(parent.getName());
// } else if
// ("Mother".equalsIgnoreCase(parent.getStudentRelation().getStudent_relation_type()))
// {
...
// ConcessionReason reasonEntity = concessions.get(0).getConcessionReason();
// if (reasonEntity != null) {
// dto.setConcessionReason(reasonEntity.getConc_reason());
// } else {
// dto.setConcessionReason("Reason data missing");
// }
// } else {
// dto.setConcessionReason("N/A");
// }
// return Optional.of(dto);
// }
// @Transactional
//// @CacheEvict(value = {"studentDetails", "campusAndZone", "employeeDetails"},
// key = "#dto.admissionNo")
// public void saveOrUpdateAdmission(ApplicationConfirmationDto dto) {
// StudentAcademicDetails academicDetails =
// academicRepo.findByStudAdmsNo(dto.getAdmissionNo())
// .orElseThrow(() -> new RuntimeException("Invalid Admission No: " +
// dto.getAdmissionNo()));
...
// }
//
// private void saveOrUpdateConcessions(ApplicationConfirmationDto dto,
// StudentAcademicDetails academicDetails) {
// if (dto.getConcessions() == null || dto.getConcessions().isEmpty()) {
// return;
// }
// for (ConcessionDTO conc : dto.getConcessions()) {
// Optional<StudentConcessionType> existingConcession =
// findConcessionByStudentAndType(
...
// Integer currentReasonId = (currentReason == null) ? null :
// currentReason.getConc_reason_id();
...
// .orElseThrow(() -> new RuntimeException("Invalid Concession Reason ID: " +
// newReasonId));
...
// AcademicYear year =
// academicYearRepo.findById(getAcademicYearIdForConcession(conc.getConcessionTypeId()))
// .orElseThrow(() -> new RuntimeException("Invalid Academic Year ID"));
// entity.setAcademicYear(year);
// entity.setConc_amount(conc.getConcessionAmount().floatValue());
// ConcessionType concessionType =
// concessionTypeRepo.findById(conc.getConcessionTypeId())
// .orElseThrow(() -> new RuntimeException("Concession type not found for ID: "
// + conc.getConcessionTypeId()));
...
// }
//
// private void updateAcademicDetails(ApplicationConfirmationDto dto,
// StudentAcademicDetails academicDetails) {
...
// int[] languageIds =
// dto.getLanguages().stream().mapToInt(LanguageDTO::getLangId).toArray();
...
// }
//
// private void updatePersonalDetails(ApplicationConfirmationDto dto,
// StudentAcademicDetails academicDetails) {
// Optional<StudentPersonalDetails> personalDetailsOptional =
// personalRepo.findByStudentAcademicDetails(academicDetails);
// StudentPersonalDetails personalDetails =
// personalDetailsOptional.orElseGet(StudentPersonalDetails::new);
...
// .orElseThrow(() -> new RuntimeException("Invalid Food Type ID: " +
// dto.getFoodType()));
...
// }
//
// private void saveOrUpdateParentDetails(ApplicationConfirmationDto dto,
// StudentAcademicDetails academicDetails) {
// StudentRelation fatherRelation =
// studentRelationRepo.findByStudentRelationType("Father")
// .orElseThrow(() -> new RuntimeException("Student relation 'Father' not
// found."));
// StudentRelation motherRelation =
// studentRelationRepo.findByStudentRelationType("Mother")
// .orElseThrow(() -> new RuntimeException("Student relation 'Mother' not
// found."));
...
// }
// }
// List<ParentDetails> existingParents =
// parentDetailsRepo.findByStudentAcademicDetails(academicDetails);
// if (fatherName != null) {
// ParentDetails father = existingParents.stream()
// .filter(p -> p.getStudentRelation().getStudent_relation_id() ==
// fatherRelation
...
// }
//
// private void saveOrUpdateCourseDetails(ApplicationConfirmationDto dto,
// StudentAcademicDetails academicDetails) {
// Optional<StudentOrientationDetails> existingDetails =
// studentOrientationDetailsRepository.findByStudentAcademicDetails(academicDetails);
...
// .orElseThrow(() -> new RuntimeException("Invalid Section ID: " +
// dto.getSectionId())));
// }
...
// }
//
// private Optional<StudentConcessionType>
// findConcessionByStudentAndType(Integer studAdmsId,
// Integer concessionTypeId) {
// return
// concessionRepo.findByStudAdmsIdAndConcessionType_ConcTypeId(studAdmsId,
// concessionTypeId);
// }
//
// @Cacheable(value = "employeeDetails", key = "#admissionNo")
// public Optional<EmployeeDetailsDTO> getEmployeeDetailsByAdmissionNo(String
// admissionNo) {
// Optional<StudentAcademicDetails> academicDetailsOptional =
// academicRepo.findByStudAdmsNo(admissionNo);
// if (academicDetailsOptional.isEmpty()) {
...
// dto.setEmployeeName(employee.getFirst_name() + " " +
